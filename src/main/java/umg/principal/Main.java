...
//PruebaInsertaUsuario();
    ...
    private static void PruebaInsertaUsuario() {
        ...
        user.setCarne("0905-14-12345");
        user.setNombre("tilin");
    ...
    private static void PruebaActualizacionUsuario() {
        ...
        User usurioObtenido;
        //obtener información del usuario por carnet y id
        try {
            usurioObtenido = servicioUsuaio.getUserByEmail("ALopez@gmail.com");
            System.out.println("Retrieved User"+ usurioObtenido.getCarne());
